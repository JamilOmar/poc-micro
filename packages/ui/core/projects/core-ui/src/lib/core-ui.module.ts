...
@NgModule({
  declarations: [CoreUiComponent, SideNavComponent],
  imports: [
    BrowserModule,
  ...
  exports: [CoreUiComponent, SideNavComponent],
...
export class CoreUiModule {
  ...
  static forRoot(
    ...
    return {
      ...
      providers: [ConfigService, AuthService, {provide: APP_CONF, useValue: settings.appConf}]
    };
  }
}
